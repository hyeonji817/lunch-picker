...
export default function RestaurantPicker({ controls }: { controls: ReactNode }) {
  ...
  return <PickerLayout controls={<>
    ...
    </>} search={current && !spinning && <RestaurantSearch kind="meal" menuName={current.name} />}>
